    ...
    <div className="flex lg:flex-col justify-between gap-4">
      ...
      <Select
        ...
        onValueChange={(value) => {
          ...
          // applyFilters(), 0) runs applyFilters() right after the state update (using a 0ms delay ensures the latest value is used — it defers execution to the next event loop tick).
